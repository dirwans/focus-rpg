...
export default function ArctronSprite({ job, size = 60, width, height, upperBodyOnly = false, fill = false, isBattle = false, clipHead = false, style: extraStyle }) {
  ...
  let img = isBattle ? "/assets/arctron/arctron_warrior_battle.png?v=11" : "/assets/arctron/arctron_warrior.png?v=11"
  if (lane === 'ranger') img = "/assets/arctron/arctron_ranger.png?v=11"
  else if (lane === 'specialist') img = "/assets/arctron/arctron_technician.png?v=11"
