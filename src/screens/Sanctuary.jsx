...
const EXIT_LABEL = 'CLOSE THE WARD'

const NPC_ROSTER = [
  { name: 'Weapon Master', subView: 'arsenal_keeper', icon: 'sword', color: '#a855f7', glow: 'rgba(168,85,247,0.9)' },
  { name: 'Armor Master', subView: 'armory_keeper', icon: 'shield', color: '#c084fc', glow: 'rgba(192,132,252,0.9)' },
  { name: 'Mining Supplier', subView: 'mining_supplier', icon: 'pick', color: '#e9d5ff', glow: 'rgba(233,213,255,0.8)' },
  { name: 'Potion Merchant', subView: 'potion_merchant', icon: 'potion', color: '#34d399', glow: 'rgba(52,211,153,0.9)' },
  { name: 'Warehouse Keeper', subView: 'vault_keeper', icon: 'box', color: '#f472b6', glow: 'rgba(244,114,182,0.8)' },
  { name: 'Enchantment Master', subView: 'forge_master', icon: 'sparkle', color: '#c084fc', glow: 'rgba(192,132,252,0.9)' },
  { name: 'Craft Master', subView: 'master_artisan', icon: 'hammer', color: '#fb7185', glow: 'rgba(251,113,133,0.8)' },
  { name: 'Guild Manager', subView: 'guild_steward', icon: 'castle', color: '#fbbf24', glow: 'rgba(251,191,36,1)' },
  { name: 'Premium Shop', subView: 'premium_shop_mgr', icon: 'gem', color: '#e879f9', glow: 'rgba(232,121,249,0.9)' },
  { name: 'Quest Manager', subView: 'grand_warden', icon: 'scroll', color: '#e879f9', glow: 'rgba(232,121,249,0.8)', dim: true },
...
export default function Sanctuary() {
  ...
  const theme = getFactionTheme('celestra')
  const primary = theme.primary || '#a855f7'
  const bgImage = '/assets/celestra/celestra_panel_bg.png'
  const crd = player?.resources?.crd?.toLocaleString() || '0'
  const jobName = player?.job?.toUpperCase() || 'PALADIN'
  ...
  const NAV_ITEMS = [
    { id: 'hq', label: 'SANCTUARY', path: 'M3 11h18v11H3z' },
  ...
  return (
    <div style={{
      ...
      <style>{`
        @keyframes celestraPulse {
          0%, 100% { box-shadow: 0 0 6px #a855f7, inset 0 0 3px #a855f7; opacity: 0.85; }
          50% { box-shadow: 0 0 16px #c084fc, 0 0 25px #9333ea, inset 0 0 6px #c084fc; opacity: 1; }
        }
        .hq-npc-grid {
      ...
      <nav className="hq-sidebar" style={{
        ...
        width: 80,
        zIndex: 20,
        background: 'rgba(20,10,32,0.65)',
        backdropFilter: 'blur(14px) saturate(180%)',
        borderRight: '1px solid rgba(168,85,247,0.35)',
        boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.08), 0 -6px 24px rgba(168,85,247,0.2)',
        display: 'flex',
        ...
        <div style={{
          ...
          {NAV_ITEMS.map((n) => (
            ...
            >
              <svg width={21} height={21} viewBox="0 0 24 24" fill="none" stroke={n.id === 'hq' ? primary : '#818cf8'} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
                <path d={n.path} />
              </svg>
              <span style={{
      ...
      <div style={{
        ...
        {/* Celestra Arc-Sanctuary Background */}
        <div style={{
          position: 'absolute',
          inset: 0,
        ...
        <div style={{
          position: 'absolute',
          inset: 0,
          background: 'linear-gradient(180deg, rgba(13,7,20,0.4), rgba(13,7,20,0.65))',
        }} />
        ...
        <div className="hq-header" style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              borderRadius: '50%',
              background: '#a855f7',
              animation: 'celestraPulse 1.8s infinite alternate',
            }} />
            <span style={{ fontSize: 13, fontWeight: 700, color: '#fae8ff' }}>{crd} CRD</span>
          </div>

          {/* Centered Celestra Sanctuary Badge */}
          <div style={{
            margin: '0 auto',
            fontFamily: "'Share Tech Mono', monospace",
            fontSize: 14,
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              border: deployArmed ? '2px solid #e9d5ff' : '2px solid #a855f7',
              borderRadius: 20,
              padding: '10px 28px',
              color: '#fae8ff',
              fontFamily: "'Share Tech Mono', monospace",
              ...
              letterSpacing: 2,
              cursor: 'pointer',
              boxShadow: deployArmed ? '0 0 30px rgba(168,85,247,0.9)' : '0 0 15px rgba(168,85,247,0.4)',
              display: 'flex',
              alignItems: 'center',
              gap: 8,
            }}
          >
            <span style={{ fontSize: 12, color: '#c084fc' }}>{deployArmed ? '⚡' : '◈'}</span>
