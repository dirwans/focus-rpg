...
export default function HQScreen() {
  ...
  const bgImage = race === 'bionex'
    ? '/assets/bionex/bionex_panel_bg.png'
    : race === 'celestra'
    ? '/assets/celestra/celestra_panel_bg.png'
    : '/assets/hq_industrial_hangar_bg.png'
    ...
    <div style={{
      ...
      <div className="hq-mecha-frame" style={{
        ...
        <div style={{
          ...
          height: 64,
          zIndex: 12,
          backgroundImage: "url('/assets/top_bezel_hq_arctron.webp?v=4')",
