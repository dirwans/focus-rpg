...
const styles = {
  ...
  sub: { fontFamily: 'var(--font-mono)', fontSize: 11, color: '#4a8fa8', marginTop: 2 },
  selectBtn: { background: 'linear-gradient(95deg, #0050cc, #00a8ff)', border: '1px solid #00e5ff', borderRadius: 8, padding: '8px 12px', fontFamily: 'var(--font-title)', fontSize: 9, color: '#fff', cursor: 'pointer', boxShadow: '0 0 10px rgba(0, 168, 255, 0.4)', transition: 'all 0.2s', fontWeight: 700 },
  resRow: { display: 'flex', gap: 8, padding: '10px 16px' },
  resChip: (c) => ({ flex: 1, background: 'rgba(3, 8, 20, 0.8)', border: `1px solid ${c}`, borderRadius: 10, padding: '8px 12px', fontFamily: 'var(--font-mono)', fontSize: 12, color: c, boxShadow: `0 0 10px ${c}33, inset 0 0 6px ${c}22` }),
  ...
  sectionLabel: { fontFamily: 'var(--font-title)', fontSize: 9, letterSpacing: 2, color: '#4a8fa8', marginBottom: 10, fontWeight: 700, textShadow: '0 0 6px rgba(0, 229, 255, 0.2)' },
  ...
  expText: { fontFamily: 'var(--font-mono)', fontSize: 11, color: '#4a8fa8', textAlign: 'right' },
  statsGrid: { display: 'flex', gap: 8 },
  statBox: { flex: 1, background: 'rgba(3, 8, 20, 0.6)', border: '1px solid rgba(0, 229, 255, 0.15)', borderRadius: 10, padding: '10px 8px', display: 'flex', flexDirection: 'column', gap: 4, fontFamily: 'var(--font-mono)', fontSize: 11, alignItems: 'center', boxShadow: 'inset 0 0 8px rgba(0, 229, 255, 0.05)' },
  statNum: { fontFamily: 'var(--font-mono)', fontSize: 18, fontWeight: 900, color: '#e0f4ff', textShadow: '0 0 6px rgba(0, 229, 255, 0.2)' },
  desc: { fontFamily: 'var(--font-body)', fontSize: 12, color: '#6a9ab8', marginBottom: 8, lineHeight: 1.5 },
  ...
  specTitle: { fontFamily: 'var(--font-title)', fontSize: 9, color: '#7ab0d0', letterSpacing: 0.5, marginTop: 4, fontWeight: 700 },
  specItem: (c) => ({ fontFamily: 'var(--font-body)', fontSize: 12, color: c, lineHeight: 1.4 }),
  ...
  progLabel: { fontFamily: 'var(--font-title)', fontSize: 9, color: '#4a8fa8', fontWeight: 700 },
}
