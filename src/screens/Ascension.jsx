...
const EVO_IMAGES = {
  ...
  spirit_seraphys_32: '/assets/spirit_seraphys_32.png?v=3',
  spirit_seraphys_42: '/assets/spirit_seraphys_42.png?v=3',
  spirit_seraphys_55: '/assets/spirit_seraphys_55.png?v=3',
  spirit_seraphys_65: '/assets/spirit_seraphys_65.png?v=3',
  // Celestra Ancient Spirit - Noctyrna
  spirit_noctyrna_32: '/assets/spirit_noctyrna_32.png?v=3',
  spirit_noctyrna_42: '/assets/spirit_noctyrna_42.png?v=3',
  spirit_noctyrna_55: '/assets/spirit_noctyrna_55.png?v=3',
  spirit_noctyrna_65: '/assets/spirit_noctyrna_65.png?v=3',
}
