...
> Auto-generated from Arctron Dressing Room on 7/16/2026, 2:02:18 PM
...
const GEAR_POINTS = {
  ...
  shield: [{ x: -0.182, y: 0.503, ax: 0.5, ay: 0.5, size: 0.457, rot: 0, z: 4 }],
...
- **Tier**: LV1
- **Race**: Arctron
- **Base Skin**: /assets/arctron_warrior.png
